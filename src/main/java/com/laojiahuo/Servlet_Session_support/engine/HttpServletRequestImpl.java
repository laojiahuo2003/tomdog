...
import com.laojiahuo.Servlet_Session_support.connector.HttpExchangeRequest;
import com.laojiahuo.Servlet_Session_support.engine.support.HttpHeaders;
import com.laojiahuo.Servlet_Session_support.engine.support.Parameters;
import com.laojiahuo.Servlet_Session_support.utils.HttpUtils;
...
public class HttpServletRequestImpl implements HttpServletRequest {
    ...
    /**
     * 1.从Cookie中获取name为JSESSIONID的value，作为sessionId
     * 2.如果不存在，创建会话id
     * 3.通过Set-Cookie响应头设置一个cookie
     * @param create
     * @return
     */
    @Override
